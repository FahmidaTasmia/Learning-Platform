...
const Blog = () => {
    return (
        <div >
            ...
            <div className='mt-24'>
            <h1 className='text-center md:text-3xl font-serif mb-8 uppercase font-bold'>Learn Somthing More</h1>
            <p className='text-center mb-16 md:mx-24 lg:text-lg'>In order to create an engaging learning experience, the role of instructor is optional, but the role of learner is essential.eLearning shouldn’t be a casual joy ride on a Sunday afternoon with the cruise control engaged. The sole purpose of eLearning is to teach.</p>
            <div className='grid md:grid-cols-2 md:gap-12 gap-4  md:container md:m-auto'>
           
            <div className="card w-full bg-base-100 shadow-xl rounded-none m-auto">
